        ...
        <header>
            <nav className='bg-white text-black'>
                ...
                <div className={`fixed inset-0 flex flex-col space-y-8 items-center justify-center bg-[#EEE0CB] z-50 transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                    ...
                    <Link to='/design' onClick={toggleMenu} className={`font-bodoni mplus text-3xl mb-4 hover:underline transform transition-transform duration-300 ${isOpen ? '-translate-y-0' : 'translate-y-full'}`}>
