    ...
    return (
        <div className='flex flex-col min-h-screen'>
            ...
            <div className='text-left mb-8 ml-8'>
                <h1 className='text-4xl font-inknut tracking-wide uppercase text-gray-900'>Waiwaolani</h1>
                <p className='text-2xl font-inknut text-gray-700 mt-2'>Design Assistant to Brand Founder</p>
            </div>
